...
<div class="login-form">
    <form action="/examples/actions/confirmation.php" id="loginform" method="POST">
        ...
        <div class="form-group">
         <input type="submit" class="btn btn-primary login-btn btn-block" name="submit" id="submit" value="login">
        </div>
        <div class="clearfix">
